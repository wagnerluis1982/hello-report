"""
Django settings for HelloReport project.
...
SECRET_KEY = '7dfparwfbatlz1xjhgdltlav9*^c$tkywn1afl=r!0k(juk@aw'
...
WSGI_APPLICATION = 'helloreport.wsgi.application'


# Database
# https://docs.djangoproject.com/en/2.0/ref/settings/#databases

db_from_url = partial(dj_database_url.parse, conn_max_age=600)
